...
export const metadata: Metadata = {
  ...
  description: "To provide efficient, innovative and reliable logistics solutions that ensure goods and packages reach their destinations safely and on time.",
};
